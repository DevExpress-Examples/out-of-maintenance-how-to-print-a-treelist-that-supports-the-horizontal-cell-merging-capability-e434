...
'INSTANT VB NOTE: The variable node was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private node_Renamed As TreeListNode
'INSTANT VB NOTE: The variable currentColumn was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private currentColumn_Renamed As TreeListColumn
'INSTANT VB NOTE: The variable previousColumn was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private previousColumn_Renamed As TreeListColumn
'INSTANT VB NOTE: The variable currentCellDisplayText was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private currentCellDisplayText_Renamed As String
'INSTANT VB NOTE: The variable previousCellDisplayText was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private previousCellDisplayText_Renamed As String
'INSTANT VB NOTE: The variable merge was renamed since Visual Basic does not allow variables and other class members to have the same name:
...
'INSTANT VB NOTE: The variable currNode was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private currNode_Renamed As TreeListNode
'INSTANT VB NOTE: The variable prevNode was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private prevNode_Renamed As TreeListNode
'INSTANT VB NOTE: The variable column was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private column_Renamed As TreeListColumn
'INSTANT VB NOTE: The variable currCellVisibleText was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private currCellVisibleText_Renamed As String
'INSTANT VB NOTE: The variable prevCellVisibleText was renamed since Visual Basic does not allow variables and other class members to have the same name:
